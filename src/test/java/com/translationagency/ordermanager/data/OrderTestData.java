...
public class OrderTestData {
    ...
    public static final List<OrderTo> firstTen = OrderUtil.getTos(List.of(stevenOrder, markOrder, jackieOrder,
            joyOrder, colleenOrder, terriOrder, sarahOrder, lauraOrder, michelleOrder, sharonOrder));
